...
public class Adjacenncy_Linked_List_Graph {
	Vertex[] adjList;
	
	public Adjacenncy_Linked_List_Graph(String f) throws FileNotFoundException{
	...
	private void breadthFirstTraversal(int v,boolean[] checks,MyQueue queue){
		checks[v]=true;
		queue.push(v);
		while(!queue.isEmpty()){
			int i = (int)queue.pop();
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Adjacenncy_Linked_List_Graph a = new Adjacenncy_Linked_List_Graph(sc.next());
		a.print();
		System.out.println("\n DFS");
